...
class TestSpellTrigger(unittest.TestCase):
    ...
    def test_constructor(self):
        """test"""
        trigger = SpellTrigger(tests.TRIGGER_TYPE["TEST_01"])
    ...
    def test_get_name_with_type(self):
        ...
        trigger = SpellTrigger("test trigger", trigger_type)
        self.assertEqual("test trigger", trigger.get_name())
    ...
    def test_equal(self):
        ...
        spell_trigger2 = SpellTrigger("trigger 01", tests.TRIGGER_TYPE["TEST_01"])
        spell_trigger3 = SpellTrigger("trigger 02", tests.TRIGGER_TYPE["TEST_02"])
