...
class TestStaffEvent(unittest.TestCase):
    ...
    def test_get_created(self):
        """ test """
        staff_event = StaffEvent(const.SPELL_TRIGGER_TYPE['TEST_01'], 99)
        self.assertEqual(99, staff_event.get_created())

    def test_equal(self):
        """ test """
        staff_event1 = StaffEvent(const.SPELL_TRIGGER_TYPE['TEST_01'], 4)
        staff_event2 = StaffEvent(const.SPELL_TRIGGER_TYPE['TEST_01'], 4)
        staff_event3 = StaffEvent(const.SPELL_TRIGGER_TYPE['TEST_02'], 4)
