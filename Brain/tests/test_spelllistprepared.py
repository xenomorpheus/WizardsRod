...
class TestSpellListPrepared(unittest.TestCase):
    ...
    def test_add_spell(self):
        """test"""
        slp = SpellListPrepared()
        slp_got = slp.add_spell(Spell("Test Spell 01"))
        self.assertEqual(slp, slp_got, "builder pattern. must be object")

    def test_add_spells(self):
        """test"""
        slp = SpellListPrepared()
        slp_got = slp.add_spells([Spell("Test Spell 01")])
        self.assertEqual(slp, slp_got, "builder pattern. must be object")
    ...
    def test_remove_spell(self):
        ...
        slp = SpellListPrepared()
        slp.add_spells([test_spell01])
        slp_got = slp.remove_spell(test_spell01)
        self.assertEqual(slp, slp_got, "builder pattern. must be object")
    ...
    def test_receive_events_some_spells_unwanted_events(self):
        ...
        slp = SpellListPrepared().add_spell(test_spell01)
    ...
    def test_receive_events_one_spells_no_events(self):
        """test"""
        slp = SpellListPrepared().add_spell(Spell("Test Spell 01"))
    ...
    def test_receive_events_some_spells(self):
        ...
        slp = SpellListPrepared().add_spells([test_spell01, test_spell02, test_spell03, test_spell04])
        new_events = [RodEvent("TEST_01", 4), RodEvent("TEST_02", 4), RodEvent("TEST_03", 4)]
        spells_activated = slp.receive_events(new_events)
    ...
    def test_get_hardware_hints(self):
        ...
        slp = SpellListPrepared().add_spells([test_spell01, test_spell02])
